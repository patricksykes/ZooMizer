...
plotSpectra(fish_params, wlim = c(10^-14.5, NA))
...
steady_fish <-  steady(fish_params, t_max = 200, return_sim = TRUE, dt = 0.1, t_per = 5.5)
plotBiomass(steady_fish)
plotSpectra(steady_fish, time_range = 1)
