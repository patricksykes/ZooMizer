...
intercept <- tail(getCommunitySlope(stable_zoo)$intercept,1)
slope <- tail(getCommunitySlope(stable_zoo)$slope,1)
...
fish_params <- newTraitParams(no_sp = 5,
                              ...
                              kappa = 10^intercept, #10^(input$phyto_int) * 10^-1,
...
plotSpectra(fish_params, wlim = c(10^-14.5, NA), total = TRUE, power = 2)
