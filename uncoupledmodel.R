...
fZooMizer_run <- function(groups, input, no_w = 178){
  ...
  #mf.params@initial_n[] <- readRDS("data/initialn.RDS")
  mf.params@initial_n_pp <- kappa*mf.params@w_full^(1-lambda) / mf.params@dw_full #returns the fixed spectrum at every time step
  mf.params@initial_n_pp[mf.params@w_full > mf.params@resource_params$w_pp_cutoff* (1 - 1e-06)] <- 0
