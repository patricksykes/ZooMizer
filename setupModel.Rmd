...
ID <- 123 #index of environmental data to choose
enviro_row <- readRDS("data/envirofull_20200317.RDS")[ID,]

#set up the fixed phyoplankton spectrum
phyto_fixed <- function(params, n, n_pp, n_other, rates, dt = 0.1, phyto_int = enviro_row$phyto_int, phyto_slope = enviro_row$phyto_slope,...) {
